...
export const PRODUCTS: Product[] = [
  ...
  createProduct('f-7', 'Banana', 'केला', 'কলা', 'Banana', 63, 'https://images.unsplash.com/photo-1571771896328-7963057c1510?auto=format&fit=crop&w=800&q=80', 'Regular Cavendish bananas.', 'kg'),
  createProduct('f-8', 'Banana Poovam', 'पूवन केला', 'পুভাম কলা', 'Banana', 63, 'https://images.unsplash.com/photo-1603833665858-e61d17a86224?auto=format&fit=crop&w=800&q=80', 'Small sweet Poovam bananas.', 'kg'),
  createProduct('f-9', 'Cantaloupe', 'खरबूजा', 'খরমুজ', 'Melon', 31, 'https://images.unsplash.com/photo-1598511726623-d09063d8d747?auto=format&fit=crop&w=800&q=80', 'Sweet muskmelon.', 'kg'),
  createProduct('f-10', 'Custard Apple', 'सीताफल', 'আতা', 'Tropical', 57, 'https://images.unsplash.com/photo-1591185387430-811f5926ec3e?auto=format&fit=crop&w=800&q=80', 'Creamy custard apples.', 'kg', { isLocal: true }),
  createProduct('f-11', 'Gooseberry', 'आंवला', 'আমলকী', 'Berry', 115, 'https://images.unsplash.com/photo-1623227866882-c005c2680234?auto=format&fit=crop&w=800&q=80', 'Vitamin C rich Amla.', 'kg'),
  createProduct('f-12', 'Grapes Black', 'काले अंगूर', 'কালো আঙ্গুর', 'Grapes', 85, 'https://images.unsplash.com/photo-1625499743422-790d93976472?auto=format&fit=crop&w=800&q=80', 'Seedless black grapes.', 'kg'),
  createProduct('f-13', 'Grapes Green', 'हरे अंगूर', 'সবুজ আঙ্গুর', 'Grapes', 95, 'https://images.unsplash.com/photo-1596363505729-41905a189512?auto=format&fit=crop&w=800&q=80', 'Sweet green grapes.', 'kg'),
  createProduct('f-14', 'Guava', 'अमरूद', 'পেয়ারা', 'Tropical', 56, 'https://images.unsplash.com/photo-1536882240095-0379873feb4e?auto=format&fit=crop&w=800&q=80', 'Fresh pink guava.', 'kg'),
  ...
  createProduct('f-16', 'Lychee', 'लीची', 'লিচু', 'Exotic', 215, 'https://images.unsplash.com/photo-1596230529625-7ee54133528b?auto=format&fit=crop&w=800&q=80', 'Sweet juicy lychees.', 'kg'),
  createProduct('f-17', 'Mango', 'आम', 'আম', 'Mango', 102, 'https://images.unsplash.com/photo-1553279768-865429fa0078?auto=format&fit=crop&w=800&q=80', 'King of fruits.', 'kg'),
  createProduct('f-18', 'Orange', 'संतरा', 'কমলা', 'Citrus', 70, 'https://images.unsplash.com/photo-1547514701-42782101795e?auto=format&fit=crop&w=800&q=80', 'Fresh Nagpur oranges.', 'kg'),
  createProduct('f-19', 'Papaya', 'पपीता', 'পেঁপে', 'Tropical', 38, 'https://images.unsplash.com/photo-1626016776236-e81c00918c4c?auto=format&fit=crop&w=800&q=80', 'Ripe sweet papaya.', 'pc'),
  createProduct('f-20', 'Pears', 'नाशपाती', 'নাশপাতি', 'Imported Fruit', 97, 'https://images.unsplash.com/photo-1615484477207-2d8993029051?auto=format&fit=crop&w=800&q=80', 'Imported pears.', 'kg'),
  ...
  createProduct('f-22', 'Pomegranate Kabul', 'काबुली अनार', 'কাবুলি বেদানা', 'Exotic', 125, 'https://images.unsplash.com/photo-1615486511484-92e172cc4fe0?auto=format&fit=crop&w=800&q=80', 'Deep red pomegranate.', 'kg'),
  createProduct('f-23', 'Sapota', 'चीकू', 'সবেদা', 'Tropical', 55, 'https://images.unsplash.com/photo-1621255755252-73a73c4d3731?auto=format&fit=crop&w=800&q=80', 'Sweet sapota (Chiku).', 'kg'),
  createProduct('f-24', 'Sugar Cane', 'गन्ना', 'आঁখ', 'Other', 30, 'https://images.unsplash.com/photo-1543235777-679942484a0d?auto=format&fit=crop&w=800&q=80', 'Fresh sugar cane stalks.', 'pc'),
